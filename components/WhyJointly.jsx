...
export default function WhyJointly() {
  return (
    <section id="why-jointly" className="w-full bg-white text-ink pt-20 pb-32">
      <div className="max-w-container mx-auto px-6 w-full">
        
        {/* Logo Wall Marquee */}
        <div className="relative w-full overflow-hidden mb-32 mask-edges-white border-y border-gray-100 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-start max-w-xl">
            ...
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-ink mb-6">
              Your products deliver. <br/>
              <span className="text-muted">Your marketing should too.</span>
            </h3>
            ...
            <Link href="/contact" className="px-8 py-4 rounded-full bg-majorelle text-white font-semibold text-lg hover:bg-opacity-90 transition-all shadow-lg shadow-majorelle/30">
              Get in touch
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col space-y-6">
              {/* Testimonial Card */}
              <div className="bg-lavender rounded-3xl p-8 relative shadow-lg">
                <img src={WhyJointlyQuote.src || WhyJointlyQuote} alt="quote" className="absolute top-6 right-6 w-8 h-6 opacity-30" />
                <p className="text-ink font-medium text-lg leading-snug mb-6 relative z-10">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-bold text-ink text-sm">Jarl Hobbs</h4>
                      <p className="text-muted text-xs">Head of Brand & Marketing</p>
                    </div>
                  </div>
