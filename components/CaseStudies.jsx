    ...
    <section className="bg-[#2B2733] py-20 md:py-32 overflow-hidden font-sans">
      <div className="max-w-[1000px] mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <h2 className="text-[36px] md:text-5xl lg:text-[56px] leading-[1.1] font-bold text-white mb-5 tracking-tight max-w-[650px]">
            The work behind the results
          </h2>
          <p className="text-gray-300 text-[16px] md:text-lg leading-relaxed max-w-[600px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
          {caseStudies.map((study, idx) => (
            <div key={idx} className="bg-white rounded-[32px] p-5 md:p-6 flex flex-col group shadow-lg transition-transform duration-300 hover:-translate-y-2">
              <Link href={study.link} className="relative block aspect-[1.5] md:aspect-[1.6] rounded-2xl md:rounded-[20px] overflow-hidden mb-6 md:mb-8 bg-gray-100">
                <img 
                  src={study.imgSrc} 
                  alt={study.title} 
              ...
              <div className="flex flex-col justify-between flex-grow px-2 md:px-4 pb-2 md:pb-4">
                <Link href={study.link} className="block mb-8">
                  <h3 className="text-xl md:text-[26px] font-bold leading-tight text-[#2B2733] tracking-tight group-hover:text-[#874FD4] transition-colors">
                    {study.title}
                  </h3>
                </Link>
                <Link href={study.link} className="inline-flex items-center text-[#874FD4] text-sm md:text-[15px] font-semibold group/link w-fit">
        ...
        <div className="flex justify-center mt-4">
          <Link href="/case-studies" className="px-10 py-3.5 md:py-4 rounded-full bg-[#874FD4] text-white font-semibold text-[14px] md:text-[15px] hover:bg-purple-700 transition-all shadow-lg hover:scale-105">
            View more
          </Link>
        </div>
