    ...
    <section className="bg-neutral-800 py-20 md:py-32 overflow-hidden font-sans">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          <h2 className="text-[36px] md:text-5xl lg:text-[56px] leading-[1.1] font-bold text-neutral-100 mb-5 tracking-tight max-w-[800px]">
            Insights for the construction sector
          </h2>
          <p className="text-neutral-300 text-[16px] md:text-lg leading-relaxed max-w-[800px] px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12 md:mb-16">
          {blogPosts.map((post, idx) => (
            <div key={idx} className="bg-neutral-100 rounded-[32px] p-5 md:p-6 flex flex-col group shadow-lg transition-transform duration-300 hover:-translate-y-2 h-full">
              <Link href={post.link} className="relative block aspect-[1.5] md:aspect-[1.6] rounded-2xl md:rounded-[20px] overflow-hidden mb-6 bg-neutral-200 shrink-0">
                <img 
                  src={post.imgSrc} 
                  alt={post.title} 
              ...
              <div className="flex flex-col flex-grow px-1 md:px-2 pb-2">
                <div className="flex items-center space-x-2 text-primary-100 font-bold text-[11px] md:text-[12px] mb-3 md:mb-4">
                ...
                <Link href={post.link} className="block mb-3">
                  <h3 className="text-xl md:text-[22px] font-bold leading-tight text-neutral-800 tracking-tight group-hover:text-primary-100 transition-colors">
                    {post.title}
                  </h3>
                </Link>
                
                <p className="text-neutral-500 text-[14px] md:text-[15px] leading-relaxed mb-6 font-medium flex-grow">
                  {post.description}
                </p>

                <div className="mt-auto">
                  <Link href={post.link} className="inline-flex items-center text-primary-100 text-sm md:text-[15px] font-semibold group/link w-fit">
                    <span>Read more</span>
        ...
        <div className="flex justify-center mt-4">
          <Link href="/blog" className="px-10 py-3.5 md:py-4 rounded-full bg-primary-100 text-neutral-100 font-semibold text-[14px] md:text-[15px] hover:bg-primary-100/90 transition-all shadow-lg hover:scale-105">
            View more
          </Link>
        </div>
